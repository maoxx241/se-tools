...
import { hostTransferReport } from '../lib/host-transfers.mjs';
...
} else if (command === 'host-transfers') {
  console.log(JSON.stringify(await hostTransferReport(input ? JSON.parse(await fs.readFile(input,'utf8')) : {}),null,2));
